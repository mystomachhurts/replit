...
(define head
  (place-image eye 30 30(place-image eye 70 30 no-eye)))
...
(define button ( circle 7 "solid" "orange"))
(define comp (place-image button 100 150(place-image button 100 175 (place-image button 100 200 snowman ))))
...
(define hat ( rectangle 50 100 "solid" "gray"))
(define hatt (above hat  snowman))


; Make the dominos logo